...
<script>
    ...
    methods: {
        fetchCustomer(id){
            this.$http.get('http://localhost/traversy/slim/public/index.php/api/customer/'+id)
        ...
        updateCustomer(e){
            if(!this.customer.first_name || !this.customer.last_name || !this.customer.email){
                ...
                this.$http.put('http://localhost/traversy/slim/public/index.php/api/customer/update/'+this.$route.params.id, updCustomer)
                    .then(function(response){
